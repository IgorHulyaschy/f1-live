...
import { TEAM_COLORS, COLUMNS } from '../../../constants';
import { getStatusLabel } from '../../../utils';
import { ActionDropdown } from '../ActionDropdown';
import { PositionChange } from '../PositionChange';
import styles from './DriverRow.module.css';
import positionStyles from './DriverRow.position.module.css';
import rowStyles from './DriverRow.row.module.css';
import sectorStyles from './DriverRow.sector.module.css';
import statusStyles from './DriverRow.status.module.css';
import tireStyles from './DriverRow.tire.module.css';

import type { RowProps } from '../../../types';
import { MoreVerticalIcon } from '@/components/ui/Icons';

export default function DriverRow({ driver, onActionClick, activeDropdown }: RowProps) {
