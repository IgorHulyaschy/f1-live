...
import { formatLapTime, formatSectorTime } from '../../utils/lapTimeFormatter';

import type { Driver, Lap } from '../../types/real-data-we-have.types';
...
export default function SimpleLiveTable() {
	...
	const driversWithLatestLap: DriverWithLatestLap[] = data.driversLapsData.map((driverData) => {
		const sortedLaps = [...driverData.laps].sort((a, b) => b.lapNumber - a.lapNumber);
		const latestLap = sortedLaps[0];
